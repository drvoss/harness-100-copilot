...
Quick reference checklist for web application performance. Use alongside the `performance-optimizer` harness (29-performance-optimizer).

> Adapted from [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) references/performance-checklist.md
