...
Quick reference for WCAG 2.1 AA compliance. Relevant for frontend work in any harness.

> Adapted from [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) references/accessibility-checklist.md
...
- [ARIA Live Regions Quick Reference](#aria-live-regions-quick-reference)
