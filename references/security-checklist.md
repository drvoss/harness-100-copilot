...
Quick reference for web application security. Use alongside the `security-audit` harness (28-security-audit).

> Adapted from [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) references/security-checklist.md
