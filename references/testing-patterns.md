...
Quick reference for common testing patterns across the stack. Use alongside the `test-automation` harness (24-test-automation).

> Adapted from [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) references/testing-patterns.md

## Table of Contents

- [Test Structure (Arrange-Act-Assert)](#test-structure-arrange-act-assert)
- [Test Naming Conventions](#test-naming-conventions)
- [Common Assertions (Jest)](#common-assertions-jest)
